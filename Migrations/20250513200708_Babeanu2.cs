...
{
    /// <inheritdoc />
    public partial class Babeanu2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BorrowingMethod = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookRequests_Borrowings_BorrowingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookRequests_BorrowingId",
                table: "BookRequests",
                column: "BorrowingId");
